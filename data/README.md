...
This directory contains input data used for the analysis:
 ...
 - [Zost_binding_data.csv](./Zost_binding_data.csv) antibody binding and competition data from [Zost, et al., 2020](https://www.nature.com/articles/s41586-020-2548-6). 
