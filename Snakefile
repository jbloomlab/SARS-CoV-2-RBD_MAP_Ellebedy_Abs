...
rule make_summary:
    ...
    input:
        ...
        ellebedy_evol='results/summary/evolution_escape_Ellebedy.md',
    ...
    run:
        ...
        with open(output.summary, 'w') as f:
            ...
            9. Analyze escape profiles in light of evolutionary and functional constraint for [here]({path(input.ellebedy_evol)}).
...
rule ellebedy_evol:
    ...
    output:
        md='results/summary/evolution_escape_Ellebedy.md',
        md_files = directory('results/summary/evolution_escape_Ellebedy_files')
    envmodules:
        'R/3.6.2-foss-2019b'
    params:
        nb='evolution_escape_Ellebedy.Rmd',
        md='evolution_escape_Ellebedy.md',
        md_files='evolution_escape_Ellebedy_files'
    shell:
        """
