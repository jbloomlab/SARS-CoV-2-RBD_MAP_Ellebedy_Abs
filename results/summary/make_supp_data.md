...
```
    ...
    Plotting correlations of mutation escape for Ellebedy_invivo
...
![png](make_supp_data_files/make_supp_data_14_1.png)
    ...
    Plotting correlations of site escape for Ellebedy_invivo
...
```
    ...
    Raw data for Ellebedy_invivo (first few lines):
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    Writing to results/supp_data/Ellebedy_invivo_raw_data.csv
...
```
    ...
    Writing `dms-view` input file for Ellebedy_invivo to results/supp_data/Ellebedy_invivo_dms-view_data.csv
